#!/usr/bin/env bash
# Put .colors.csv in your home directory Add the following functions to your
# .bash_profile # Change colors and fonts of the OSX terminal from the command
# line:  $ set_foreground_color lime green $ set_font "Oxygen Mono" 12

#
# # Colors for Apple Terminal # function list_colors { cat ${HOME}/.colors.csv }
